...
public class JE_QP_6_FOSUpload1 {
	...
	public void click_fos_upload1_button_in_menu() {
		...
		wait.until(ExpectedConditions
				.elementToBeClickable(By.xpath("//*[@id=\"kt_aside_menu\"]/ul/li[4]/div/ul/li[1]/a/span")));
	...
	public void upload_valid_file_in_fos_upload1() throws AWTException {
		WebDriverWait wait = new WebDriverWait(driver, Duration.ofMinutes(3));
		wait.until(ExpectedConditions
				.elementToBeClickable(By.xpath("//*[@id=\"ContentPlaceHolder1_divForm\"]/div/div[1]/div[3]")));
	...
	public void click_download_button_in_fos_upload1() {
		WebDriverWait wait = new WebDriverWait(driver, Duration.ofMinutes(3));
		wait.until(ExpectedConditions
				.elementToBeClickable(By.xpath("//*[@id=\"ContentPlaceHolder1_gvFileLog_imbExport_0\"]/span")));
	...
	public void click_fos_upload2_button_in_menu() {
		...
		ele.click();
		wait.until(ExpectedConditions
				.elementToBeClickable(By.xpath("//*[@id=\"kt_aside_menu\"]/ul/li[4]/div/ul/li[2]/a/span")));
	...
	public void click_off_fleet_upload_button_in_menu() {
		...
		ele.click();
		wait.until(ExpectedConditions
				.elementToBeClickable(By.xpath("//*[@id=\"kt_aside_menu\"]/ul/li[4]/div/ul/li[3]/a/span")));
