...
public class JE_QP_5_Setup {
	...
	public void click_view_trips2_button_in_gl_upload2() {
		...
		ele.click();
		wait.until(ExpectedConditions.elementToBeClickable(By.xpath("//*[@id=\"kt_aside_menu\"]/ul/li[5]/div/ul/li[1]/a/span")));
	...
	public void click_gl_code_setup_button_in_setup() {
		...
		ele = driver.findElement(By.xpath("//*[@id=\"kt_aside_menu\"]/ul/li[5]/a/span[2]"));
		ele.click();
		wait.until(ExpectedConditions.elementToBeClickable(By.xpath("//*[@id=\"kt_aside_menu\"]/ul/li[5]/div/ul/li[2]/a/span")));
	...
	public void click_save_button_in_gl_code_setup() {
		...
		WebDriverWait wait=new WebDriverWait(driver, Duration.ofMinutes(1));
		wait.until(ExpectedConditions.elementToBeClickable(By.xpath("/html/body/form/div[5]/div/div[2]/div[2]/div[1]/div/div[1]/div/div/div[3]/div/input[1]")));
		ele = driver.findElement(By.xpath("/html/body/form/div[5]/div/div[2]/div[2]/div[1]/div/div[1]/div/div/div[3]/div/input[1]"));
		ele.click();
		try {
			Alert alert = driver.switchTo().alert();
			String text = alert.getText();
	...
	public void click_edit_button_in_gl_code_setup() {
		WebDriverWait wait=new WebDriverWait(driver, Duration.ofMinutes(1));
		wait.until(ExpectedConditions.elementToBeClickable(By.xpath("//*[@id=\"ContentPlaceHolder1_gvGLCode_lnkEdit_0\"]/span")));
	...
	public void click_company_gl_setup_button_in_setup() {
		...
		ele = driver.findElement(By.xpath("//*[@id=\"kt_aside_menu\"]/ul/li[5]/a/span[2]"));
		ele.click();
		wait.until(ExpectedConditions.elementToBeClickable(By.xpath("//*[@id=\"kt_aside_menu\"]/ul/li[5]/div/ul/li[3]/a/span")));
	...
	public void select_valid_date_in_effective_from_calendar_in_company_gl_setup() {
		...
		ele.click();
		//Date select
		wait.until(ExpectedConditions.elementToBeClickable(By.xpath("//*[@id=\"kt_body\"]/div[6]/div[1]/table/tbody/tr[5]/td[5]")));
	...
	public void click_edit_button_in_company_gl_setup() {
		WebDriverWait wait=new WebDriverWait(driver, Duration.ofMinutes(1));
		wait.until(ExpectedConditions.elementToBeClickable(By.xpath("//*[@id=\"ContentPlaceHolder1_gvCompanySetup_lnkEdit_0\"]/span")));
	...
	public void click_rate_setup_button_in_setup() {
		...
		ele = driver.findElement(By.xpath("//*[@id=\"kt_aside_menu\"]/ul/li[5]/a/span[2]"));
		ele.click();
		wait.until(ExpectedConditions.elementToBeClickable(By.xpath("//*[@id=\"kt_aside_menu\"]/ul/li[5]/div/ul/li[6]/a/span[1]")));
	...
	public void click_price_setup_button_in_setup() {
		...
		ele = driver.findElement(By.xpath("//*[@id=\"kt_aside_menu\"]/ul/li[5]/a/span[2]"));
		ele.click();
		wait.until(ExpectedConditions.elementToBeClickable(By.xpath("//*[@id=\"kt_aside_menu\"]/ul/li[5]/div/ul/li[7]/a/span[1]")));
	...
	public void click_ns_customer_button_in_setup() {
		...
		ele = driver.findElement(By.xpath("//*[@id=\"kt_aside_menu\"]/ul/li[5]/a/span[2]"));
		ele.click();
		wait.until(ExpectedConditions.elementToBeClickable(By.xpath("//*[@id=\"kt_aside_menu\"]/ul/li[5]/div/ul/li[8]/a/span[1]")));
	...
	public void click_edit_button_in_ns_customer() {
		WebDriverWait wait=new WebDriverWait(driver, Duration.ofMinutes(1));
		wait.until(ExpectedConditions.elementToBeClickable(By.xpath("//*[@id=\"ContentPlaceHolder1_gvCustomerMapping_lnkEdit_0\"]/span")));
	...
	public void click_exclude_line_item_button_in_setup() {
		...
		ele = driver.findElement(By.xpath("//*[@id=\"kt_aside_menu\"]/ul/li[5]/a/span[2]"));
		ele.click();
		wait.until(ExpectedConditions.elementToBeClickable(By.xpath("//*[@id=\"kt_aside_menu\"]/ul/li[5]/div/ul/li[9]/a/span[1]")));
