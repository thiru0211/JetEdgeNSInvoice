...
public class JE_QP_4_GL_UPLOAD_2 {
	...
	public void click_view_trips2_button_in_gl_upload2() {
		...
		ele.click();
		wait.until(ExpectedConditions.elementToBeClickable(By.xpath("//*[@id=\"kt_aside_menu\"]/ul/li[2]/div/ul/li[1]/a/span")));
	...
	public void select_valid_from_date_in_view_trips2() {
		...
		ele2.click();
		//2021 click
		wait.until(ExpectedConditions.elementToBeClickable(By.xpath("//*[@id=\"kt_body\"]/div[6]/div[3]/table/tbody/tr/td/span[3]")));
	...
	public void click_edit_button_in_view_trips2() {
		WebDriverWait wait=new WebDriverWait(driver, Duration.ofMinutes(3));
		wait.until(ExpectedConditions.elementToBeClickable(By.xpath("//*[@id=\"ContentPlaceHolder1_gvTripDetails_lnkEdit_0\"]/span")));
	...
	public void click_edit_line_item_button_in_view_trips2() {
		WebDriverWait wait=new WebDriverWait(driver, Duration.ofMinutes(3));
		wait.until(ExpectedConditions.elementToBeClickable(By.xpath("//*[@id=\"ContentPlaceHolder1_gvSalesLineItem_lnkEdit_0\"]/span")));
	...
	public void click_edit_button_in_customer_name_in_view_trips2() {
		WebDriverWait wait=new WebDriverWait(driver, Duration.ofMinutes(3));
		wait.until(ExpectedConditions.elementToBeClickable(By.xpath("//*[@id=\"ContentPlaceHolder1_lnkEditCust\"]/span")));
	...
	public void click_global_config_setup_button_in_gl_upload2() {
		...
		ele = driver.findElement(By.xpath("//*[@id=\"kt_aside_menu\"]/ul/li[2]/a/span[2]"));
		ele.click();
		wait.until(ExpectedConditions.elementToBeClickable(By.xpath("//*[@id=\"kt_aside_menu\"]/ul/li[2]/div/ul/li[2]/a/span")));
