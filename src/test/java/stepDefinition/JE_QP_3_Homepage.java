...
public class JE_QP_3_Homepage {
	...
	public void click_gl_code_setup_button_in_homepage() {
		...
		wait.until(ExpectedConditions.elementToBeClickable(By.xpath("//*[@id=\"kt_content\"]/div/div/div/div[1]/div[1]/div/ul/li[1]/a/span[2]")));
	...
	public void click_ignored_trip_setup_button_in_homepage() {
		WebDriverWait wait=new WebDriverWait(driver, Duration.ofMinutes(1));
		wait.until(ExpectedConditions.elementToBeClickable(By.xpath("//*[@id=\"kt_content\"]/div/div/div/div[1]/div[1]/div/ul/li[2]/a/span[2]")));
	...
	public void click_ns_fos_file_upload_button_in_homepage() {
		WebDriverWait wait=new WebDriverWait(driver, Duration.ofMinutes(1));
		wait.until(ExpectedConditions.elementToBeClickable(By.xpath("//*[@id=\"kt_content\"]/div/div/div/div[1]/div[1]/div/ul/li[3]/a/span[2]")));
	...
	public void click_ns_audit_report_button_in_homepage() {
		WebDriverWait wait=new WebDriverWait(driver, Duration.ofMinutes(1));
		wait.until(ExpectedConditions.elementToBeClickable(By.xpath("//*[@id=\"kt_content\"]/div/div/div/div[1]/div[1]/div/ul/li[4]/a/span[2]")));
	...
	public void click_ns_verify_trips_button_in_homepage() {
		WebDriverWait wait=new WebDriverWait(driver, Duration.ofMinutes(1));
		wait.until(ExpectedConditions.elementToBeClickable(By.xpath("//*[@id=\"kt_content\"]/div/div/div/div[1]/div[1]/div/ul/li[5]/a/span[2]")));
	...
	public void click_ns_upload_button_in_homepage() {
		WebDriverWait wait=new WebDriverWait(driver, Duration.ofMinutes(1));
		wait.until(ExpectedConditions.elementToBeClickable(By.xpath("//*[@id=\"kt_content\"]/div/div/div/div[1]/div[1]/div/ul/li[6]/a/span[2]")));
	...
	public void click_view_trips_button_in_error_tab() {
		WebDriverWait wait=new WebDriverWait(driver, Duration.ofMinutes(1));
		wait.until(ExpectedConditions.elementToBeClickable(By.xpath("//*[@id=\"kt_content\"]/div/div/div/div[2]/div[1]/div/div/div[2]/p/a")));
	...
	public void click_view_trips_button_in_good_to_go_tab() {
		WebDriverWait wait=new WebDriverWait(driver, Duration.ofMinutes(1));
		wait.until(ExpectedConditions.elementToBeClickable(By.xpath("//*[@id=\"kt_content\"]/div/div/div/div[2]/div[3]/div/div/div[2]/p/a")));
	...
	public void click_view_trips_button_in_verified_tab() {
		WebDriverWait wait=new WebDriverWait(driver, Duration.ofMinutes(1));
		wait.until(ExpectedConditions.elementToBeClickable(By.xpath("//*[@id=\"kt_content\"]/div/div/div/div[2]/div[5]/div/div/div[2]/p/a")));
	...
	public void click_view_trips_button_in_ns_pending_tab() {
		WebDriverWait wait=new WebDriverWait(driver, Duration.ofMinutes(1));
		wait.until(ExpectedConditions.elementToBeClickable(By.xpath("//*[@id=\"kt_content\"]/div/div/div/div[2]/div[7]/div/div/div[2]/p/a")));
	...
	public void click_view_trips_button_in_not_ready_in_fos_tab() {
		WebDriverWait wait=new WebDriverWait(driver, Duration.ofMinutes(1));
		wait.until(ExpectedConditions.elementToBeClickable(By.xpath("//*[@id=\"kt_content\"]/div/div/div/div[2]/div[9]/div/div/div[2]/p/a")));
	...
	public void click_view_trips_button_in_gl_code_pending_item_code_tab() {
		WebDriverWait wait=new WebDriverWait(driver, Duration.ofMinutes(1));
		wait.until(ExpectedConditions.elementToBeClickable(By.xpath("//*[@id=\"kt_content\"]/div/div/div/div[2]/div[11]/div/div/div[2]/p/a")));
	...
	public void click_view_trips_button_in_ignored_tab() {
		WebDriverWait wait=new WebDriverWait(driver, Duration.ofMinutes(1));
		wait.until(ExpectedConditions.elementToBeClickable(By.xpath("//*[@id=\"kt_content\"]/div/div/div/div[2]/div[13]/div/div/div[2]/p/a")));
	...
	public void click_view_trips_1_button() {
		WebDriverWait wait=new WebDriverWait(driver, Duration.ofMinutes(1));
		wait.until(ExpectedConditions.elementToBeClickable(By.xpath("//*[@id=\"kt_quick_user\"]/div[2]/div[3]/a[1]/div/div[2]/div[1]")));
	...
	public void click_non_inventory_line_item_button() {
		WebDriverWait wait=new WebDriverWait(driver, Duration.ofMinutes(1));
		wait.until(ExpectedConditions.elementToBeClickable(By.xpath("//*[@id=\"kt_quick_user\"]/div[2]/div[3]/a[2]/div/div[2]/div[1]")));
	...
	public void click_gl_code_setup_button() {
		WebDriverWait wait=new WebDriverWait(driver, Duration.ofMinutes(1));
		wait.until(ExpectedConditions.elementToBeClickable(By.xpath("//*[@id=\"kt_quick_user\"]/div[2]/div[3]/a[3]/div/div[2]/div[1]")));
	...
	public void click_company_gl_setup_button() {
		WebDriverWait wait=new WebDriverWait(driver, Duration.ofMinutes(1));
		wait.until(ExpectedConditions.elementToBeClickable(By.xpath("//*[@id=\"kt_quick_user\"]/div[2]/div[3]/a[4]/div/div[2]/div[1]")));
	...
	public void click_company_setup_button() {
		WebDriverWait wait=new WebDriverWait(driver, Duration.ofMinutes(1));
		wait.until(ExpectedConditions.elementToBeClickable(By.xpath("//*[@id=\"kt_quick_user\"]/div[2]/div[3]/a[5]/div/div[2]/div[1]")));
	...
	public void click_global_config_setup_button() {
		WebDriverWait wait=new WebDriverWait(driver, Duration.ofMinutes(1));
		wait.until(ExpectedConditions.elementToBeClickable(By.xpath("//*[@id=\"kt_quick_user\"]/div[2]/div[3]/a[6]/div/div[2]/div[1]")));
	...
	public void click_upload_fos_report_button(Double double1) {
		WebDriverWait wait=new WebDriverWait(driver, Duration.ofMinutes(1));
		wait.until(ExpectedConditions.elementToBeClickable(By.xpath("//*[@id=\"kt_quick_user\"]/div[2]/div[3]/a[7]/div/div[2]/div[1]")));
