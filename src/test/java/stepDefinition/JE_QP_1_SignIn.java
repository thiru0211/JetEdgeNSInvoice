...
public class JE_QP_1_SignIn {
	...
	public void Click_Signout_button_in_homepage() {
		WebDriverWait wait=new WebDriverWait(driver, Duration.ofMinutes(1));
		wait.until(ExpectedConditions.elementToBeClickable(By.xpath("//*[@id=\"kt_quick_user\"]/div[2]/div[1]/div[2]/div[2]/a")));
		ele = driver.findElement(By.xpath("//*[@id=\"kt_quick_user\"]/div[2]/div[1]/div[2]/div[2]/a"));
		ele.click();
	}
	...
	public void Click_forget_password_button_in_NSInvoice() throws InterruptedException {
		WebDriverWait wait=new WebDriverWait(driver, Duration.ofMinutes(1));
