Feature: FOS UPLOAD 1.0
  ...
  Scenario: FOS UPLOAD 1.0:Valid Check
    ...
    Then Click help button in FOS Upload1
    Then close the FOS Upload Page
  ...
  Scenario: FOS UPLOAD 1.0:Valid Check
    ...
    Then Click menu button in homepage in FOS Upload
    And Click FOS Upload1 button in menu
    Then Click upload button in FOS Upload1
    Then close the FOS Upload Page
  ...
  Scenario: FOS UPLOAD 1.0:Valid Check
    ...
    And Enter valid notes "TEST" in FOS Upload1
  ...
  Scenario: FOS UPLOAD 2.0:Valid Check
    ...
    Then Click help button in FOS Upload2
    Then close the FOS Upload Page
  ...
  Scenario: FOS UPLOAD 2.0:Valid Check
    ...
    Then Click menu button in homepage in FOS Upload
    And Click FOS Upload2 button in menu
    Then Click upload button in FOS Upload2
    Then close the FOS Upload Page
  ...
  Scenario: FOS UPLOAD 2.0:Valid Check
    ...
    And Enter valid notes "TEST" in FOS Upload2
  ...
  Scenario: OFF-FLEET UPLOAD:Valid Check
    ...
    And Enter valid notes "TEST" in Off-Fleet Upload
