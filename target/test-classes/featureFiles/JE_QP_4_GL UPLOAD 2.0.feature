Feature: GL UPLOAD2.0
  ...
  Scenario: GL UPLOAD2.0:View Trips
    ...
    Then close the GL UPLOAD2 Page
  ...
  Scenario: GL UPLOAD2.0:View Trips
    ...
    Then Click Global Config Setup button in GL UPLOAD2
    And Select valid date in choose date in Global Config Setup
    Then Click Live hour by leg radio button in Global Config Setup
    And Click Block Hour radio button in Global Config Setup
    Then Click update button in Global Config Setup
    Then close the GL UPLOAD2 Page