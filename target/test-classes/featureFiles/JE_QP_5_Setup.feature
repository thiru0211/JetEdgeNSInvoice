Feature: SETUP
  ...
  Scenario: Setup:Fuel Surcharge Setup
    ...
    And Click Fuel Surcharge Setup button in Setup
    Then Click add new button in Fuel Surcharge Setup
    And Enter valid trip purpose "Test" in Fuel Surcharge Setup
  ...
  Scenario: Setup:Fuel Surcharge Setup
    ...
    And Click Fuel Surcharge Setup button in Setup
    Then Click add new button in Fuel Surcharge Setup
    And Enter valid trip purpose "Testers" in Fuel Surcharge Setup
    Then Click Quoted live hour radio button in Fuel Surcharge Setup
    And Click Trip end date radio button in Fuel Surcharge Setup
    Then Enter valid start date in Fuel Surcharge Setup
    And Enter valid end date in Fuel Surcharge Setup
  ...
  Scenario: Setup:Fuel Surcharge Setup
    ...
    And Click Fuel Surcharge Setup button in Setup
    Then Click add new button in Fuel Surcharge Setup
    And Enter valid trip purpose "Testing" in Fuel Surcharge Setup
  ...
  Scenario: Setup:Fuel Surcharge Setup
    ...
    And Click Fuel Surcharge Setup button in Setup
    Then Click add new button in Fuel Surcharge Setup
    And Enter valid trip purpose "Tester" in Fuel Surcharge Setup
    Then Click Actual live hour radio button in Fuel Surcharge Setup
  ...
  Scenario: Setup:GL Code Setup
    ...
    Then Select All option in GP Upload Flag option tab in GL Code Setup
    And Select All option in Status option tab in GL Code Setup
    Then Enter valid Item code "Apollo Jets" in GL Code Setup
    And Click search button in GL Code Setup
    Then close the Setup Page
  ...
  Scenario: Setup:GL Code Setup
    ...
    And Click GL Code Setup button in Setup
    Then Click add new button in GL Code Setup
    And Click save button in GL Code Setup
    Then close the Setup Page
  ...
  Scenario: Setup:GL Code Setup
    ...
    And Click GL Code Setup button in Setup
    Then Click add new button in GL Code Setup
    And Select valid company name "Jet Edge" in GL Code Setup
  ...
  Scenario: Setup:GL Code Setup
    ...
    Then Enter valid Department Code "40404" in Department Code Setup in GL Code Setup
    Then close the Setup Page
  ...
  Scenario: Setup:GL Code Setup
    ...
    Then Enter valid Account Number "10" in Account Number Setup in GL Code Setup
    Then close the Setup Page
  ...
  Scenario: Setup:GL Code Setup
    ...
    Then Click revenue radio button in GL Code Setup
    And Enter FOS Item Number "TEST" in GL Code Setup
    Then Enter FOS Item Description "TEST123" in GL Code Setup
    And Enter Trip Type "TEST CHTR" in GL Code Setup
    Then Select valid effective from date in FOS Input in GL Code Setup
    And Click no radio button in Non Inventory in GL Code Setup
  ...
  Scenario: Setup:Company GL Setup
    ...
    Then Enter valid GL Code "55" in Company GL Setup
    And Enter valid trip type "TEST" in Company GL Setup
    Then Select valid date in effective from calendar in Company GL Setup
    And Enter valid notes "TEST" in Company GL Setup
    And Click clear button in Company GL Setup
    Then close the Setup Page
  ...
  Scenario: Setup:Company GL Setup
    ...
    And Enter valid trip type "TEST" in Company GL Setup
    Then Select valid date in effective from calendar in Company GL Setup
    And Enter valid notes "TESTING" in Company GL Setup
    And Click save button in Company GL Setup
    #Then close the Setup Page
  ...
  Scenario: Setup:Rate Setup
    ...
    Then Enter valid rate type "Test" in rate setup
    And Enter valid FOS Item number "123" in rate setup
    Then Enter valid Effective From in rate setup
    And Enter valid GL Code "55" in rate setup
    Then Enter valid NS Item Number "TEST123" in rate setup
    And Enter valid NS Item Description "TEST ITEM" in rate setup
    And Click clear button in rate setup
    Then close the Setup Page
  ...
  Scenario: Setup:Rate Setup
    ...
    Then Enter valid Company "Test" in rate setup
    And Enter valid FOS Item number "123" in rate setup
    Then Enter valid Effective From in rate setup
    And Enter valid GL Code "55" in rate setup
    Then Enter valid NS Item Number "TEST123" in rate setup
  ...
  Scenario: Setup:Price Setup
    ...
    And Click price Setup button in Setup
    Then Click Add new button in Setup
    And Enter valid Company name "TEST COMPANY" in price Setup
    Then Enter valid FOS Item Number "TEST COMPANY" in price Setup
    ...
    Then Enter valid Unit Price "1000" in price Setup
  ...
  Scenario: Setup:NS Customer
    ...
    And Click NS Customer button in Setup
    Then Click Add new button in NS Customer
    And Enter valid NS Customer ID "101010" in NS Customer
    Then Enter valid NS Customer Name "TEST" in NS Customer
    And Click Yes radio button in status field in NS Customer
    And Click clear button in NS Customer
    Then close the Setup Page
  ...
  Scenario: Setup:NS Customer
    ...
    And Click Exclude Line Item button in Setup
    Then Click add new button in Exclude Line Item
    And Enter valid company name "TEST" in Exclude Line Item
    Then Enter valid FOS Item Number "2024" in Exclude Line Items
